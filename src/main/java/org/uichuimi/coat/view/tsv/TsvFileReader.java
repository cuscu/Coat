...
import org.uichuimi.coat.view.graphic.IndexCell;
...
public class TsvFileReader extends VBox implements Reader {
    ...
    private final Button addFilter = new Button("Filter", new SizableImageView("/img/black/new.png", SizableImageView.SMALL_SIZE));
