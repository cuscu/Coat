...
public class GraphEvaluator extends Task<Void> {
    ...
    static {
        ...
        // Confidence in Omim
        RELATIONSHIP_SCORE.put("C", 5.0);
        RELATIONSHIP_SCORE.put("P", 3.0);
        RELATIONSHIP_SCORE.put("I", 2.0);
        RELATIONSHIP_SCORE.put("L", 1.0);
    }
    ...
    private void clear() {
        ...
        database.getPearls("phenotype").parallelStream().forEach(pearl -> pearl.setDistanceToPhenotype(0));
        total = database.numberOfPearls("gene");
        processed = 0;
    }
