...
/**
 * Standard gene name database. Use <code>getStandardSymbol()</code> to getProperty the standard HGNC symbol of the gene, and
 * <code>getName()</code> to getProperty the whole name of the gene.
 * <p>
 * 0 HGNC ID
 * 1 Approved Symbol
 * 2 Approved Name
...
public class HGNC {
    ...
    static {
        try (BufferedReader reader = new BufferedReader(new InputStreamReader(new GZIPInputStream(HGNC.class.getResourceAsStream("hgnc-complete.tsv.gz"))))) {
            reader.readLine();
