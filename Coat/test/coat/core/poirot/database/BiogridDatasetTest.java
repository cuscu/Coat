...
import coat.core.poirot.dataset.biogrid.BioGridDatasetLoader;
...
public class BiogridDatasetTest {
    ...
    @Test
    public void size() {
        Assert.assertEquals(237044, dataset.getInstances().size());
    }
    ...
    public void indexInstanceAccess() {
        ...
        Assert.assertEquals(136, dataset.getInstances("DISC1", 1).size());
        Assert.assertEquals("NDEL1", dataset.getInstances("DISC1", 1).get(0).getField(2));
    }
